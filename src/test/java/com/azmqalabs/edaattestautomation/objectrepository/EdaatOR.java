...
//    public final static String Admin_system_subBlr_Edit_verif="//h6[text()='General Info']";
	...
	public final static String Admin_SearchGroupMgm_DeleteBtn="(//table[@id='tblGroups']//tbody/tr[@role='row'])[1]//td[6]/a";
...
//individal client admin
     ...
     //Admin subbiller
       ...
       public final static String Admin_CorpoSubBillerVerfiy1="(//table[@id='tblSubBillers']//tr//td)[1]";
       public final static String Admin_CorpoSubBillerVerfiy2="(//table[@id='tblSubBillers']//tr//td)[2]";
...
//Client Payables Installments bills page
      ...
      //Client IncomingBills
       ...
       public final static String ClientsPayablesIncomInvoiceDetailsText ="//h3[text()='Invoice Details']";
 ...
 public static final String ClientAccountStatementtext = "//h3[text()='Client Account Statement']";
  ...
  //Admin System management wathiq integration History details
    ...
    public final static String Admin_Terms_Delete_Button="//a[@class='mx-1 action bg-danger deleteItem']";
	...
	public final static String Admin_TermStatusToggle="//label[@class='mb-']";
